...
import { ClassicEditor, SourceEditing, Markdown, Heading, Link, Bold, Essentials, Italic, Mention, Paragraph, List, Undo } from 'ckeditor5';
...
const editorConfiguration = {
    toolbar: toolbar,
    plugins: [
        Bold, Essentials, Italic, Mention, Paragraph, Undo, Heading, Link, List,
        SourceEditing, Markdown
    ],
    initialData: '',
};
